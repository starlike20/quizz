...
<body>
    ...
    <div id="grand">
        ...
        <h2>information des question</h2>
    </div>
    <div id="form" >
        <form action="" method="POST" enctype="multipart/form-data">
            <div class="m">
                <label>intituléQuestion</label>
                <input type="text" placeholder="entrez l'intituléQuestion" id="intituléQuestion" name="intituléQuestion"></input>
            </div>
            <div class="m">
